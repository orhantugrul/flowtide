 ...
 * @returns A promise that resolves to the current Editor object
 * @throws If the editor cannot be created or retrieved
 */
 ...
 * @returns A promise that resolves to the current Project object
 * @throws If the project cannot be created or retrieved
 */
